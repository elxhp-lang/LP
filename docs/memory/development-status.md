...
| 2026-04-26 | 管理可视化 v1.1：插件控制台新增“快速新增路由策略”表单，直接联调 `/ai/route/policies` |
| 2026-04-26 | 管理可视化 v1.2：路由策略表单新增基础校验与“一键填充模板”，降低配置错误率 |
| 2026-04-26 | 管理可视化 v1.3：策略提交后显示最近一次回显（策略 ID/插件任务/更新时间），提升运营确认效率 |
| 2026-04-26 | 管理可视化 v1.4：路由策略支持“编辑/删除”闭环（后端 delete 接口 + 控制台操作按钮） |
| 2026-04-26 | 管理可视化 v1.5：路由策略列表支持关键词筛选与更新时间排序，提升策略定位速度 |
| 2026-04-26 | 管理可视化 v1.6：路由策略支持多选与批量删除（delete-batch 接口 + 控制台批量操作） |
